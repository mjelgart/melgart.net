  ...
  return (
    <Layout home>
      ...
      <section className={`${utilStyles.headingMd}`}>
        <p>I’m a software engineer at Meta, previously IBM. I grew up in Miami, graduated from Duke in North Carolina, and now live with my family in Washington, DC.</p>
